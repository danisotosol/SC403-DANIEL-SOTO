...
// CLASE 12 - PASO D.3: descomentado junto con el resto del bloque.
...
// CLASE 12 - PASO D.3: requiere el PASO D.1 (security/Rol.java).
...
public class UsuarioService {
    ...
    public Usuario crear(Usuario usuario) {
        // CLASE 12 - PASO D.3: valida el rol antes de guardar (requiere el
        // metodo validarRol() de mas abajo).
    ...
    public Usuario actualizar(Long id, Usuario formUsuario) {
        // CLASE 12 - PASO D.3: misma validacion que en crear().
    ...
    // CLASE 12 - PASO D.3: antes de esto, un typo en el rol ("Admin", "ADM",
    // etc., escrito a mano en un formulario o en un POST JSON a la API)
    // pasaba silenciosamente a la base de datos - el usuario quedaba creado,
    // pero @PreAuthorize nunca iba a reconocer ese rol. Validar contra
    // Rol.valueOf(...) rechaza esos casos con un error claro.
